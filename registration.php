...
<html>
	<head>
		...
		<title>Registration : PRESENSI RFID/NFC</title>
	</head>
	
	<body>

		<h2 align="center">PRESENSI RFID/NFC</h2>
		<ul class="topnav">
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="insertDB.php" method="post" >
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="nomor" type="text" placeholder="" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="kelas" type="text"  placeholder="" required>
						</div>
					</div>
