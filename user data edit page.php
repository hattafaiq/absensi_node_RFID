<?php
	...
	$sql = "SELECT * FROM tabel_rfid_mysql where id = ?"; //
	$q = $pdo->prepare($sql);
	$q->execute(array($id)); //
...
<html>
	<head>
		...
		<title>Edit : PRESENSI RFID/NFC NODEMCU ESP8266</title>
		
	</head>
	
	<body>

		<h2 align="center">PRESENSI RFID/NFC NODEMCU ESP8266</h2>
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id?>" method="post">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="nomor" type="text" placeholder="" value="<?php echo $data['nomor'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="kelas" type="text"  placeholder="" value="<?php echo $data['kelas'];?>" required>
						</div>
					</div>
